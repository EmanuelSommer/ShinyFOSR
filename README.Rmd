...
For the full version that also supports Confidence Intervals (CI) you need to download the file containing the models with enhanced uncertainty quantification capabilities from [this permanent link](train_mod_sparse_sd.RDS). Follow the instructions below to install the package and run the app.
